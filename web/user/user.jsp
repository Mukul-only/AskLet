...
<body>
    <section id="navigation" class="white">
        <nav class="nav">
            ...
            <div class="log-out">
                <a href="../index.jsp" class="nav-l"><button class="lot">Logout</button></a>
            </div>
    ...
    <section id="title" class="container">
        <div class="catch-phrase">
            ...
            <h1 class="welcome">Welcome , <span><%= request.getParameter("name")%></span></h1>
        ...
        <div class="features-in">
            <div class="ft">
                ...
                <p>We take the hard work out of research by giving you the tools to deep dive into the latest data from
                    markets. You will  be able to connect with your audience in an instant.</p>
            </div>
            <div class="ft">
